...
def test_novel_nested_resources(client):
    ...
    Chapter.objects.create(title='Chapter One', novel=novel1, is_completed=True, ordinal=0)
    Chapter.objects.create(title='Chapter Two', novel=novel1, ordinal=1)
    num_novel_one_chapters = 2
    Chapter.objects.create(title='Chapter 1', novel=novel2, ordinal=0)
...
def test_chapter_nested_resources(client):
    ...
    chapter1 = Chapter.objects.create(title='Chapter One', novel=novel, is_completed=True, ordinal=0)
    chapter2 = Chapter.objects.create(title='Chapter Two', novel=novel, ordinal=1)
